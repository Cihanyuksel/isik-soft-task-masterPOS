...
import { setInitialTheme, toggleThemeMode } from "../features/layout/layoutSlice";
...
export const ThemeToggle: React.FC = () => {
  ...
  return (
    <div className="flex items-center gap-[10px]">
      <MdOutlineWbSunny className="text-3xl -m-7" />
      <button onClick={() => dispatch(toggleThemeMode())} className="cursor-pointer">
      ...
      <IoMoonOutline className="text-3xl margin" />
    </div>
  );
};
